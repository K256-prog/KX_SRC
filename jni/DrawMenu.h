...
std::string cimodkey = "t.me/BranSai69";
std::string xyzBuyKey = "t.me/BranSai69";
...
void DrawMenu() {
    ...
    std::string FULLTITLE = std::string("KX") + std::string(" | ") + clientManager.c_str() + std::string(" | ") + std::string(ABI);
		...
		if (ImGui::BeginTabBar("Tab", ImGuiTabBarFlags_FittingPolicyScroll)) {
            ...
            if (ImGui::BeginTabItem("Setting")) {
                ImGui::BeginGroupPanel("Menu Setting", ImVec2(-1.0f, 0.0f));
                {
                    ...
                    {
						Text("Report Bug: "); SameLine();
                        TextColored(RGBA2ImVec4(176, 40, 40, 255), "@BranSai69");
